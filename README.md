...
需要注意的是，不论如何固定，**电机齿轮必须尽量与八音盒齿轮紧密配合**，否则可能会产生噪音并损坏齿轮。
...
处于空间利用方面的考量，推荐使用PCB实现上图中电路。作者水平稀烂，只能画出一手烂板子。如需要，请点击[这里][gerber_url]。*注：仅适用于乐积TMC2209模块*
...
### 菜单与设置
在主视图中长按可进入主菜单。在主菜单中选择`Back and Save`以保存设置并回到主菜单。在主菜单中无操作30秒会自动返回主界面。
...
[schema_url]:https://github.com/mr258876/Project-Orgel/blob/main/PCB/Schematic_Project%20Orgel_2021-11-29.png?raw=true
[gerber_url]:https://github.com/mr258876/Project-Orgel/blob/main/PCB/Gerber_PCB_Project%20Orgel?raw=true
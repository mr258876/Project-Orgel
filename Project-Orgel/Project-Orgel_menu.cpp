...
const PROGMEM AnyMenuInfo minfoBackToHomepage = { "Back To Homepage", 19, 0xffff, 0, backToHomepage };
ActionMenuItem menuBackToHomepage(&minfoBackToHomepage, NULL);
...
TextMenuItem menuAboutText3(fnAboutText3RtCall, 18, 1, &menuAboutText4);
RENDERING_CALLBACK_NAME_INVOKE(fnAboutText2RtCall, textItemRenderFn, "Mr258876 at Github", -1, NO_CALLBACK)
...
const PROGMEM AnalogMenuInfo minfoDriveRatio = { "Value", 16, 48, 2047, NO_CALLBACK, 0, 1, "" };
...
TextMenuItem menuGearText2(fnGearText2RtCall, 17, 1, &menuDriveRatio);
RENDERING_CALLBACK_NAME_INVOKE(fnGearText1RtCall, textItemRenderFn, "Gear of Orgel", -1, NO_CALLBACK)
TextMenuItem menuGearText1(fnGearText1RtCall, 15, 1, &menuGearText2);
...
SubMenuItem menuSettings(&minfoSettings, &menuBackSettings, &menuBackToHomepage);
const PROGMEM AnalogMenuInfo minfoBPM = { "BPM", 2, 2, 511, setSpeed, 0, 1, "" };
AnalogMenuItem menuBPM(&minfoBPM, 0, &menuSettings);
const PROGMEM BooleanMenuInfo minfoPlay = { "playStatus", 1, 0xffff, 1, switchPlayStatus, NAMING_ON_OFF };

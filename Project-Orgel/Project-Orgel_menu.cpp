...
const PROGMEM AnyMenuInfo minfoBPMTweak = { "BPM Tweak", 28, 12, 0, setBpmTweak };
EditableLargeNumberMenuItem menuBPMTweak(&minfoBPMTweak, LargeFixedNumber(7, 6, 1U, 0U, false), true, &menuVoltage, INFO_LOCATION_PGM);
const PROGMEM AnalogMenuInfo minfoCurrent = { "Current", 22, 5, 2047, setCurrent, 0, 1, "mA" };
AnalogMenuItem menuCurrent(&minfoCurrent, 1023, &menuBPMTweak, INFO_LOCATION_PGM);
